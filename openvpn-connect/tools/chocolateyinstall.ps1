...
$downloadArgs = @{
  ...
  url             = 'https://swupdate.openvpn.net/downloads/connect/openvpn-connect-3.9.0.5008_signed_x86.msi'
  checksum        = '25f7b77adf61f3856b9079e0b1bc1968e98980215f9dc72e89e8587f141d5524'
  checksumType    = 'sha256'
  url64bit        = 'https://swupdate.openvpn.net/downloads/connect/openvpn-connect-3.9.0.5008_signed.msi'
  checksum64      = '31347812dd37dbbb69bc47de842eb179827266e9dfb45e7f6ce10c5d71a5bad6'
